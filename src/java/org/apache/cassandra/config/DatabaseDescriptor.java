...
public class DatabaseDescriptor
{
    ...
    private static void applySimpleConfig()
    {
        ...
        if (conf.native_transport_rate_limiting_enabled)
            logger.info("Native transport rate-limiting enabled at {} requests/second.", conf.native_transport_requests_per_second);
        else
    ...
    */
    ...
    {
        return conf.native_transport_requests_per_second;
    }

    public static void setNativeTransportRequestsPerSecond(double perSecond)
    {
        Preconditions.checkArgument(perSecond > 0, "native_transport_requests_per_second must be greater than zero");
        conf.native_transport_requests_per_second = perSecond;
    }
