    ...
    public static class Exists extends TxnCondition
    {
        ...
        public boolean applies(TxnData data)
        {
            ...
            if (exists && reference.selectsColumn())
            {
                ...
                else if (columnData.column().isComplex()) // TODO: frozen collections?
                {
    ...
    public static class Value extends TxnCondition
    {
        ...
        public boolean applies(TxnData data)
        {
            ...
            if (column.isPartitionKey())
                return kind.operator.isSatisfiedBy(column.type, reference.getPartitionKey(data), value);

            if (column.isClusteringColumn())
                return kind.operator.isSatisfiedBy(column.type, reference.getClusteringKey(data), value);
            ...
            if (column.isComplex())
            {
                ...
                if (type.isCollection())
                {
                    ...
                    {
                        // TODO: Find a way to avoid making ElementAccessBound public
                    ...
                    {
                        Term.Terminal term = SerializationUtils.deserializeCollection(value, type);
            ...
            if (reference.selectsFrozenCollectionElement())
            {
                ...
                return kind.operator.isSatisfiedBy(comparator, element, value);
            }

            return kind.operator.isSatisfiedBy(column.type, cell.buffer(), value);
        }
