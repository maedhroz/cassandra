        ...
        .setup(cluster -> {
            ...
            try
            {
                ...
                Object[][] rows = cluster.coordinator(1)
                                         .asyncExecuteWithTracing(sessionId,
                                                                  "SELECT * FROM ks.tbl WHERE pk = 1 AND ck = 51",
                                                                  ConsistencyLevel.ONE).get();
